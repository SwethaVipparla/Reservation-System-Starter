...
public class Runner {
        ...
        static List<Object> aircrafts = Arrays.asList(
                        ...
                        PassengerPlaneFactory.createPassengerPlane("A350"),
                        PassengerPlaneFactory.createPassengerPlane("Embraer 190"),
                        PassengerPlaneFactory.createPassengerPlane("Antonov AN2"),
